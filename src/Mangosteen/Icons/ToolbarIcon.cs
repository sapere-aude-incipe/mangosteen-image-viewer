...
internal static class ToolbarIcon
{
    ...
    private static readonly IReadOnlyDictionary<ToolbarIconKind, string> PathData =
        new Dictionary<ToolbarIconKind, string>
        {
            ...
            [ToolbarIconKind.RotateLeft] = "M9.2,5.2 L4.5,8.2 L9.2,11.2 M4.9,8.2 H12.9 C16.8,8.2 19.5,10.6 19.5,14 C19.5,17.4 16.9,19.7 13.5,19.7 C11.2,19.7 9.1,18.6 7.7,16.8",
            [ToolbarIconKind.RotateRight] = "M14.8,5.2 L19.5,8.2 L14.8,11.2 M19.1,8.2 H11.1 C7.2,8.2 4.5,10.6 4.5,14 C4.5,17.4 7.1,19.7 10.5,19.7 C12.8,19.7 14.9,18.6 16.3,16.8",

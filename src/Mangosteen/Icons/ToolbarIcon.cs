...
internal static class ToolbarIcon
{
    ...
    private static readonly IReadOnlyDictionary<ToolbarIconKind, string> PathData =
        new Dictionary<ToolbarIconKind, string>
        {
            ...
            [ToolbarIconKind.RotateLeft] = "M9.1,4.9 L4.6,6.5 L6.2,10.9 M5.1,6.7 C7,5.1 9.4,4.2 12.1,4.2 C16.4,4.2 19.5,7.5 19.5,11.8 C19.5,15.7 16.8,18.8 13.2,19.4 C11.1,19.7 9.1,19 7.7,17.6",
            [ToolbarIconKind.RotateRight] = "M14.9,4.9 L19.4,6.5 L17.8,10.9 M18.9,6.7 C17,5.1 14.6,4.2 11.9,4.2 C7.6,4.2 4.5,7.5 4.5,11.8 C4.5,15.7 7.2,18.8 10.8,19.4 C12.9,19.7 14.9,19 16.3,17.6",
